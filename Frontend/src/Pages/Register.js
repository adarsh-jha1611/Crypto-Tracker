...
import backgroundImage from '../components/banner2.jpg';
...
const Register = () => {
  ...
  return (
    <div style={{ 
      ...
      <form onSubmit={handleSubmit} className="register__form" style={{ 
        background: '#F7931A', 
        borderRadius: '15px', 
        padding: '30px', 
        width: '40%' 
      }}>
        <h2 style={{ color: '#ffffff', textAlign: 'center', marginBottom: '2rem' }}>Register</h2>
        ...
        <p style={{ fontSize: '0.9rem', color: '#fff', marginTop: '1.5rem', textAlign: 'center' }}>
          Already have an account? <Link to="/login" style={{ color: '#2D4055', textDecoration: 'none', marginLeft: '5px', fontWeight: '500' }}>Login</Link>
        </p>
      </form>
    </div>
  );
